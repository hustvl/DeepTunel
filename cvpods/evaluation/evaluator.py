...
def inference_on_dataset(
    model, data_loader, evaluator: Union[DatasetEvaluator, List[DatasetEvaluator], None],teacher_model=None
):
    """
    ...
    with ExitStack() as stack:
        ...
        for idx, inputs in enumerate(data_loader):
            ...
            outputs = model(inputs) if teacher_model is None else model(inputs,teacher_model)
