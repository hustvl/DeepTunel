...
from .mimdet import build_mim_backbone
from .convnextv2 import build_convnextv2_backbone
__all__ = [
    "_assert_strides_are_log2_contiguous",
    "build_fpn_backbone",
    "build_retinanet_fpn_backbone",
    'build_retinanet_mimvit_fpn_backbone',
...
def build_fpn_backbone(cfg, input_shape: ShapeSpec, backbone_name="resnet"):
    ...
    elif backbone_name == "mim":
        bottom_up = build_mim_backbone(cfg, input_shape)
    else:
...
def build_retinanet_fpn_backbone(cfg, input_shape: ShapeSpec, backbone_name="resnet"):
    ...
    if backbone_name == "resnet":
        ...
        bottom_up = build_timm_backbone(cfg, input_shape)
    elif backbone_name == "mimvit":
        bottom_up = build_mim_backbone(cfg)
    elif backbone_name == "convnextv2":
        bottom_up = build_convnextv2_backbone(cfg)
    else:
        raise ValueError("No such backbone: {}".format(backbone_name))
...
def build_retinanet_mimvit_fpn_backbone(cfg, input_shape: ShapeSpec):
    return build_retinanet_fpn_backbone(cfg, input_shape, "mimvit")

def build_retinanet_convnextv2_fpn_backbone(cfg, input_shape: ShapeSpec):
    return build_retinanet_fpn_backbone(cfg, input_shape, "convnextv2")
